...
public class PostController {
    ...
    @PostMapping
    public ResponseEntity<PostDto.Response> createPost(@RequestBody PostDto.CreateRequest dto) {
        PostDto.Response response = postService.create(dto);
        return ResponseEntity.status(HttpStatus.CREATED).body(response);
    }

    @PatchMapping("/{id}")
    public ResponseEntity<PostDto.Response> updatePost(@RequestBody PostDto.UpdateRequest dto) {

        PostDto.Response response = postService.update(dto);
